...
merklePath_side_chain_1.forEach(function (path) {console.log(path.toString('hex'));});
crosschainContract_side1.GetBoundParentChainHeightAndMerklePathByHeight({'Value':   });
